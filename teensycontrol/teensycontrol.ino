...
void readDataFromProcessingToSerial1() {  // READ 30 datas even if there is ony 24 datas from Processing
  ...
  Serial1.print("A ");
  Serial1.println(integerFromPC[0]);
  Serial1.print("B ");
  Serial1.println(integerFromPC[1]);
  Serial1.print("C ");
  Serial1.println(integerFromPC[2]);
  Serial1.print("D ");
  Serial1.println(integerFromPC[3]);
  Serial1.print("E ");
  Serial1.println(integerFromPC[4]);
  Serial1.print("F ");
  Serial1.println(integerFromPC[5]);
  Serial1.print("G ");
  Serial1.println(integerFromPC[6]);
  Serial1.print("H ");
  Serial1.println(integerFromPC[7]);
  Serial1.print("I ");
  Serial1.println(integerFromPC[8]);
  Serial1.print("J ");
  Serial1.println(integerFromPC[9]);

  Serial1.print("K ");
  Serial1.println(PC[0]);
  Serial1.print("L ");
  Serial1.println(PC[1]);
  Serial1.print("M ");
  Serial1.println(PC[2]);
  Serial1.print("N ");
  Serial1.println(PC[3]);
  Serial1.print("O ");
  Serial1.println(PC[4]);
  Serial1.print("P ");
  Serial1.println(PC[5]);
  Serial1.print("Q ");
  Serial1.println(PC[6]);
  Serial1.print("R ");
  Serial1.println(PC[7]);
  Serial1.print("S ");
  Serial1.println(PC[8]);
  Serial1.print("T ");
  Serial1.println(PC[9]);

  Serial1.print("U ");
  Serial1.println(positionX[0]);
  Serial1.print("V ");
  Serial1.println(positionX[1]);
  Serial1.print("W ");
  Serial1.println(positionX[2]);
  Serial1.print("X ");
  Serial1.println(positionX[3]);
  Serial1.print("Y ");
  Serial1.println(positionX[4]);
  Serial1.print("Z ");
  Serial1.println(positionX[5]);
  Serial1.print("a ");
  Serial1.println(positionX[6]);
  Serial1.print("b ");
  Serial1.println(positionX[7]);
  Serial1.print("c ");
  Serial1.println(positionX[8]);
  Serial1.print("d ");
  Serial1.println(positionX[9]);
}
